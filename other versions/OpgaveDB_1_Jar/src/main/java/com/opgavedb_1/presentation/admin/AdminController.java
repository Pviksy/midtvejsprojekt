...
public class AdminController implements Initializable {
    ...
    @FXML
    private Label selectedInstructorName;
    ...
    private void updateSelectedInstructor(ActionEvent event) {
        ...
        selectedInstructorName.setText(selectedInstructor.getFirstname() + " " +
    ...
    private void updateFirstname(ActionEvent event) {
        ...
        selectedInstructorName.setText(newFirstname + " " + selectedInstructor.getLastname());
        setInstructorTable();
    }
    ...
    private void updateLastname(ActionEvent event) {
        ...
        selectedInstructorName.setText(selectedInstructor.getFirstname() + " " + newLastname);
        setInstructorTable();
    }
    ...
    private void startCreatingNewInstructor() {
        clearInputs();
        setInputsAsEditable(true);
        selectedInstructorName.setText("Ny vækstresonant");
    ...
    private void createNewInstructor(ActionEvent event) {
        ...
        if (inputsAreNotEmpty()) {
            ...
            db.sendLoginDetailsEmailToInstructor(newInstructor);

            clearInputs();
            setInputsAsEditable(false);
            createNewInstructorButton.setDisable(true);
            selectedInstructorName.setText("-");

            setInstructorTable();
        } else
            selectedInstructorName.setText("Udfyld venligst alle felter");
    }
