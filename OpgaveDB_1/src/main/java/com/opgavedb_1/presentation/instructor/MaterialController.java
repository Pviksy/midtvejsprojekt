...
public class MaterialController implements Initializable {
    ...
    public void helpDialog(ActionEvent event) {
        ...
        alert.setContentText("Her på siden kan der tilføjes materiale til systemet, og dette materiale kan tildeles tags.\n" +
                             "\n" +
                             "Øverst til højre tilføjes word-dokumenter. Vælg en titel i tekstfeltet, og tryk derefter\n" +
                             "på knappen, hvorefter filen kan vælges fra din computer.\n" +
                             "Under denne kan der tilføjes videoer. Vælg ligeledes her en titel, og indsæt\n" +
                             "derefter et link til den ønskede YouTube-video. Tryk til sidst på ”+” knappen.\n" +
                             "\n" +
                             "I midten af billedet kan eksisterende materialer omdøbes, slettes ellers tilknyttes tags.\n" +
                             "Tryk på materialet du gerne vil lave om på, og gør derefter brug af de tilhørende knapper derunder.");
        alert.showAndWait();
    }
